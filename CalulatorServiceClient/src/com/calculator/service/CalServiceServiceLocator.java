...
public class CalServiceServiceLocator extends org.apache.axis.client.Service implements com.calculator.service.CalServiceService {
    ...
    private java.lang.String CalService_address = "http://localhost:8080/CalulatorService/services/CalService";
    ...
    public com.calculator.service.CalService getCalService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.calculator.service.CalServiceSoapBindingStub _stub = new com.calculator.service.CalServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.calculator.service.CalService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.calculator.service.CalServiceSoapBindingStub _stub = new com.calculator.service.CalServiceSoapBindingStub(new java.net.URL(CalService_address), this);
                _stub.setPortName(getCalServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.calculator.com", "CalServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.calculator.com", "CalService"));
        }
