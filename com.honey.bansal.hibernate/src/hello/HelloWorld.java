...
public class HelloWorld {
	...
	public static void main(String[] args) {
		...
		Session sessionMySql = HibernateUtil.getSessionFactoryMySql().openSession();
		Transaction txMySql = sessionMySql.beginTransaction();

		Message messageMySql = new Message("Hello World");
		sessionMySql.save(messageMySql);
		...
		Message loadedMessage = (Message) thirdSession.load(Message.class, message.getId());
		System.out.println(loadedMessage.getId());
